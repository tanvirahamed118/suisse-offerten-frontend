...
const glassConstrucion = [
  ...
  //  constructions start
  {
    ...
    options: [
      { id: 944845095, label: "railing", credit: 7 },
      { id: 569325115, label: "Wall / room divider", credit: 12 },
      { id: 883145416, label: "Balcony / Terrace / Winter garden", credit: 15 },
      { id: 725047458, label: "roof", credit: 20 },
      { id: 950374485, label: "Other", credit: 5 },
    ],
  },
  {
    id: 944845095,
  ...
  //   installation start
  {
    ...
    options: [
      { id: 770964319, label: "Window", credit: 4 },
      { label: "door", credit: 7 },
      { label: "Wall", credit: 8 },
      { label: "Elsewhere", credit: 5 },
    ],
  },
  // window
  {
