...
import OrderAggrement from "./pages/Order-aggrement";
        ...
        <Routes>
          ...
          <Route element={<PrivateRoute role="seller" />}>
            <Route path="/seller-dashboard" element={<SellerDashboard />}>
              ...
              />
              <Route
                path="/seller-dashboard/offers-won"
                element={<OfferWon />}
              />
          ...
          <Route path="/order-aggrement" element={<OrderAggrement />} />
