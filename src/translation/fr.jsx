const en = {
  ...
  //   search job page
  home: "Maison",
  fill_your_order: "Remplissez votre carnet de commandes dès maintenant !",
  fill_order_des:
    "Chez Ofri, de nouvelles commandes vous attendent chaque mois. Inscrivez-vous simplement, indiquez le lieu souhaité et nous vous montrerons les emplois appropriés dans votre région.",
  learn_more: "Apprendre encore plus",
  on_this_page_craftsmen_the_area:
    "Sur cette page, les artisans peuvent trouver des emplois dans la région",
  seek: "Chercher",
  ...
  imprint_text_1: "Responsable du contenu de ce site Web :",
  ...
  imprint_text_7: "Représenté par:",
  imprint_text_8: "Mehmet Küçük",
  imprint_text_9: "Inscription:",
  imprint_text_10: "[Numéro de registre du commerce]",
  imprint_text_11: "[Tribunal d'enregistrement]",
  imprint_text_12: "[Numéro d'identification de taxe de vente]",
  imprint_text_13: "Avis de responsabilité:",
  imprint_text_14:
  ...
  imprint_text_15: "Copyright:",
  imprint_text_16:
    "Les contenus et les œuvres créés par les exploitants du site sur ces pages sont soumis à la loi allemande sur le droit d'auteur. La reproduction, l'édition, la distribution et toute forme d'utilisation en dehors des limites du droit d'auteur nécessitent l'accord écrit de l'auteur ou du créateur respectif.",
  imprint_text_17: "Protection des données:",
  imprint_text_18:
    "Des informations sur la protection des données peuvent être trouvées dans notre politique de confidentialité",
  // imprint page

  // locations page
  location_title: "Trouver des artisans locaux",
  location_text_1:
    "Sur Suisse-Offerten, vous trouverez rapidement des artisans qualifiés et certifiés dans votre région. Faites une demande et recevez plusieurs offres sans engagement et gratuitement.",
  location_text_2: "Qu'est-ce qui devrait être fait?",
  location_text_3: "Entrez une demande gratuite",
  location_text_4: "Services demandés",
